...
UPDATE kcity SET population=population + 100000 WHERE id>2390; # i = i+2와 유사, id값은 절대 변경하지 말것
# 가저오기(select) - 펼치기 - 고칠부분 찾기 - Update 
...
# 경기도 광주시 추가 - auto_increment 속성이 설정되어 있어도 ID값 임의 부여 가능 
